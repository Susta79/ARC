...
private:
    ...
    // Robot object
    ARCCode_t for_kin(Eigen::Vector<double, 6> joint, bool in_rads, bool out_rads, Eigen::Vector<double, 6> *xyzabc, Eigen::Affine3d *t16);
    ARCCode_t Jacobian(Eigen::Vector<double, 6> joint, bool in_rads, Eigen::Matrix<double, 6, 6> *J);
...
public:
    ...
    ~Robi();
    ARCCode_t inv_kin(Eigen::Vector<double, 6> xyzabc, bool front_pose, bool up_pose, bool in_rads, bool out_rads, Eigen::Vector<double, 6> *joint);
};
